...
@section('content')
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="{{ asset('plugin-inspinia/index.html') }}">{{ config('app.name', ' | BO') }}</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Route::has('login'))
                            @auth
                                <li><a class="page-scroll home" href="#home">Dashboard</a></li>
                            @else
                                <li><a class="page-scroll login" href="#login">Login</a></li>
                                ...
                                @if (Route::has('register'))
                                    <li><a class="page-scroll register" href="#register">Register</a></li>
                                @endif
                            @endauth
                        @endif
            ...
            <div class="item active">
                <div class="container">
                    ...
                    <div class="carousel-image wow zoomIn">
                        <img src="{{ asset('plugin-inspinia/img/landing/laptop.png') }}" alt="laptop" />
                    </div>
                </div>
    ...
    <section id="login" class="container services" hidden>
    </section>
    <section id="register" class="container services" hidden>
    </section>
    <section id="home" class="container services" hidden>
    </section>
    ...
    <section class="container features">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center  wow zoomIn">
                <img src="{{ asset('plugin-inspinia/img/landing/perspective.png') }}" alt="dashboard" class="img-responsive">
            </div>
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right wow fadeInRight">
                <img src="{{ asset('plugin-inspinia/img/landing/dashboard.png') }}" alt="dashboard" class="img-responsive pull-right">
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-4 wow fadeInLeft">
                    <div class="team-member">
                        <img src="{{ asset('plugin-inspinia/img/landing/avatar3.jpg') }}" class="img-responsive img-circle img-small"
                            alt="">
                ...
                <div class="col-sm-4">
                    <div class="team-member wow zoomIn">
                        <img src="{{ asset('plugin-inspinia/img/landing/avatar1.jpg') }}" class="img-responsive img-circle"
                            alt="">
                ...
                <div class="col-sm-4 wow fadeInRight">
                    <div class="team-member">
                        <img src="{{ asset('plugin-inspinia/img/landing/avatar2.jpg') }}" class="img-responsive img-circle img-small"
                            alt="">
        ...
        <div class="container">
            ...
            <div class="row features-block">
                <div class="col-lg-3 features-text wow fadeInLeft">
                    ...
                    <h2>Perfectly designed </h2>
                    <p>INSPINIA Admin Theme is a premium admin dashboard template with flat design concept. It is fully
                        responsive admin dashboard template built with Bootstrap 3+ Framework, HTML5 and CSS3, Media
                        query. It has a huge collection of reusable UI components and integrated with latest jQuery
                        plugins.</p>
                    <a href="" class="btn btn-primary">Learn more</a>
                </div>
                <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                    <img src="{{ asset('plugin-inspinia/img/landing/iphone.jpg') }}" class="img-responsive" alt="dashboard">
                </div>
        ...
        <div class="container">
            ...
            <div class="row features-block">
                <div class="col-lg-4">
                    ...
                    <div class="comments-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="{{ asset('plugin-inspinia/img/landing/avatar3.jpg') }}">
                        </a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="comments-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="{{ asset('plugin-inspinia/img/landing/avatar1.jpg') }}">
                        </a>
                        <div class="media-body">
                            <div class="commens-name">
                                Andrew Williams
                ...
                <div class="col-lg-4">
                    ...
                    <div class="comments-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="{{ asset('plugin-inspinia/img/landing/avatar2.jpg') }}">
                        </a>
                        <div class="media-body">
                            <div class="commens-name">
                                Andrew Williams
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 features-text">
                    ...
                    <p>INSPINIA Admin Theme is a premium admin dashboard template with flat design concept. It is fully
                        responsive admin dashboard template built with Bootstrap 3+ Framework, HTML5 and CSS3, Media
                        query. It has a huge collection of reusable UI components and integrated with.</p>
                </div>
                ...
                <div class="col-lg-4 wow zoomIn">
                    <ul class="pricing-plan list-unstyled">
                        ...
                        <li class="pricing-desc">
                            Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque,
                            nam an soluta sensibus.
                        </li>
            ...
            <div class="row m-t-lg">
                <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg">
                    <p>*Many desktop publishing packages and web page editors now use Lorem Ipsum as their default
                        ...
                        <span class="navy">Various versions</span> have evolved over the years, sometimes by accident,
    ...
    <section id="contact" class="gray-section contact">
        <div class="container">
            ...
            <div class="row m-b-lg">
                ...
                <div class="col-lg-4">
                    <p class="text-color">
                        ...
                        perspiciatis, totam corporis laboriosam veritatis, consectetur adipisicing elit quos non quis
                        ad perspiciatis, totam corporis ea,
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg m-b-lg">
                    <p><strong>&copy; 2015 Company Name</strong><br /> consectetur adipisicing elit. Aut eaque,
...
<script>
        $(document).ready(function () {
            ...
            $('.login').on('click', function(){ window.location = "{{ route('login') }}"; });
            $('.register').on('click', function(){ window.location = "{{ route('register') }}"; });
            $('.home').on('click', function(){ window.location = "{{ route('backend.home') }}"; });
